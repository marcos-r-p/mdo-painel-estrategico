...
export default function ProdutosPage({ fonteAtiva }) {
  const [dateRange, setDateRange] = useState({ dataIni: '', dataFim: '' });
  ...
  const estoqueTop = estoque.topPorValor || [];
    ...
    <div className="space-y-6">
      ...
      <SectionCard title="Estoque">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <KPICard
            label="Total SKUs"
            value={formatNumber(estoque.totalSKUs)}
            color="blue"
          />
          <KPICard
            label="Com Estoque"
            value={formatNumber(estoque.comEstoque)}
            color="green"
          />
          <KPICard
            label="Valor Custo"
          ...
          <KPICard
            label="Valor Venda"
            value={formatCurrency(estoque.valorVenda)}
        ...
        <div className="mt-4 rounded-lg border border-orange-200 bg-orange-50 p-3 dark:border-orange-800 dark:bg-orange-950/40">
          <p className="text-sm font-medium text-orange-800 dark:text-orange-300">
            Atencao: {formatNumber(estoque.semEstoque)} SKUs sem estoque
          </p>
          <p className="mt-1 text-xs text-orange-600 dark:text-orange-400">
            De {formatNumber(estoque.totalSKUs)} SKUs cadastrados, apenas {formatNumber(estoque.comEstoque)} possuem estoque disponivel.
