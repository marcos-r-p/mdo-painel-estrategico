    ...
    <>
      ...
      >
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  {!expanded && (
                    <span
                      className="absolute left-full ml-3 px-2.5 py-1.5 rounded-md text-xs font-medium whitespace-nowrap pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-150 hidden lg:block bg-gray-800 text-white dark:bg-gray-700 dark:text-gray-200 shadow-lg z-50"
                    >
                      {section.label}
                    </span>
                  )}
        ...
        <div className="px-3 py-3 flex-shrink-0">
          <div className="flex items-center rounded-lg px-2 py-2 text-gray-400 dark:text-gray-500 text-xs">
            <span className="flex-shrink-0 w-5 h-5 flex items-center justify-center">
