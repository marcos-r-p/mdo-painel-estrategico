...
export default function Header({
  ...
  const mesesDisponiveis = periodo?.mesesDisponiveis || [];
  const mesSelecionado = periodo?.mesSelecionado;
  const setMesSelecionado = periodo?.setMesSelecionado;
  const resultado = periodo?.resultado;
        ...
        {mesesDisponiveis.length > 0 && (
          <div className="relative" ref={periodRef}>
            ...
            >
              ...
              <span className="hidden sm:inline">{mesSelecionado ? formatMesLabel(mesSelecionado) : 'Período'}</span>
